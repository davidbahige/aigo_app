...
class CamApp(App):
    ...
    def build(self):
        ...
        # Obtenir le chemin du stockage externe
        external_storage = app_storage_path()

        # Chemin du dossier 'models' dans le stockage externe
        models_dir = os.path.join(external_storage, 'models')
        model_path = os.path.join(models_dir, 'siamesemodel.h5')
